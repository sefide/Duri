...
public interface PaymentDao {
	...
	// 나눔두리 - 포인트 히스토리 가져오기 
	List<Point> getPointHistory(SqlSessionTemplate sqlSession, Member m) throws PointHistoryException;

	// 나눔두리 - 기부금영수증 발급내역 보기
	List<DonateReceipt> getDonateReceiptHistory(SqlSessionTemplate sqlSession, Member m) throws ReceiptException;

...
public class BoardItem {
	...
	public BoardItem(int rnum, int fno, String ftype, String fTitle, String fContent, Date fWriterDate, Date fStartDate,
			Date fEndDate, String fStatus, int fValue, String fValueType, int fWriter, String mNick, String mAddress,
			String mFundType, String iName, int fdValue, int fd_ino, int fdValue2, int fd_ino2, int fdValue3,
	...
	public String toString() {
		return "BoardItem [rnum=" + rnum + ", fno=" + fno + ", ftype=" + ftype + ", fTitle=" + fTitle + ", fContent="
				...
				+ ", mNick=" + mNick + ", mAddress=" + mAddress + ", mFundType=" + mFundType + ", iName=" + iName

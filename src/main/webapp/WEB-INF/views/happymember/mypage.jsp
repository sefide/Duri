...
<div id="subContainer">
	<div class="contBox inner"><!-- inner S -->
		...
		<div style="float: left;"><h1>> 물품 후원 현황</h1></div>
		<div style="float: left;">
			<h4 style="font-weight: 600">진행중
		...
		<table class="boardList mt30">
			...
			<tr>
				...
				<td><img src="/duri/resources/HappyMyPage/images/status/wating.PNG" width="22px" height="25px" alt="승인요청중"></td>
			</tr>
			<tr>
				<td>3</td>
				<td>폼클렌징 써보고 싶어요</td>
				<td class="tleft"><a href="myQnaView.jsp">안녕하세요 저는 동생들과 셋이 살고 있습니다. 매일 빨래비누로 세수를 하다 보니..</a></td>
				<td>2019-03-15 ~ 2019-04-15</td>
				<td><img src="/duri/resources/HappyMyPage/images/status/finish.PNG" width="22px" height="23px" alt="종료"></td>
			</tr>
			</tbody>
		</table>
		...
		<div style="float: left;"><h1>> 금액 후원 현황</h1></div>
		<div style="float: left;">
			<h4 style="font-weight: 600">진행중
			<img src="/duri/resources/HappyMyPage/images/status/ing.PNG" width="26px" height="25px" alt="진행중">&nbsp;&nbsp;
			종료
		...
		<table class="boardList mt30">
			...
			<tr>
				<td>2</td>
				<td>제 동생 좀 도와주세요</td>
				<td class="tleft"><a href="myQnaView.jsp">동생이 감기에 걸렸습니다. 약만 먹으면 금방 낫는데 약 살 돈이 모자라서 감기가 더..</a></td>
				<td>2019-01-11 ~ 2019-02-11</td>

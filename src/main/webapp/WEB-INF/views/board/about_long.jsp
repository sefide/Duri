          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-3 align-items-stretch">
              <div class="text">
              	...
              	<form action="directFund.pm" name="sub1" method="POST">
              	<input type="hidden" value="${longDetail.mno}">
              	<p><input type="submit" style="width:200px" value="후원하기" class="btn btn-white px-3 py-2 mt-2"></p>
              	</form>
              </div>
            </div>
          </div>

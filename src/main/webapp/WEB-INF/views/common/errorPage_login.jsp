...
<div class="form">
  ...
  <div class="form-panel one">
    ...
    <div class="form-content">
      <p id = "txtStyle">
		로그인 정보가 옳지 않습니다. <br>
      	아이디와 비밀번호가 맞는지 다시 한번 확인해주세요 :) <br>
      </p>
  		<div style = "width : 100%; height : 50px;"	></div>
      <div class="form-group">
      	<c:if test = "${status == 'nanum'}">
          <button id="loginBtn" onclick = "goLoginPage(1);">LOGIN AGAIN</button>
      	</c:if>
      	<c:if test = "${status == 'happy'}">
          <button id="loginBtn" onclick = "goLoginPage(2);">LOGIN AGAIN</button>
      	</c:if>
...
function goLoginPage(num){
	if(num == 1){ //   나눔두리
		location.href = "nanumLogin.me";
	}else { // 행복두리 
		location.href = "happyLogin.me";
	}
}
